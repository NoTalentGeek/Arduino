...
*/
char mp3IndexBufferCharArray[6];
...
void NTGVS1053::NextPrevious(bool _isNextButton){
	...
	*/
	...
	mp3IndexBufferString.toCharArray(mp3IndexBufferCharArray, 6);
	...
	while(!vs1053.playingMusic){
		...
		*/
		if(mp3Index != -1){
			...
			Play(mp3IndexBufferCharArray);
			char repeat1[6];
			strncpy(repeat1, mp3IndexBufferCharArray, 6);
			...
			if(haveVisitedTargetExhibition){
				...
				*/
				...
				Play(mp3IndexBufferCharArray);
				char repeat2[6];
				strncpy(repeat2, mp3IndexBufferCharArray, 6);
				...
				Play(mp3IndexBufferCharArray);
				char repeat3[6];
				strncpy(repeat3, mp3IndexBufferCharArray, 6);
				...
				*/
				...
				for(int i = 0; i < 2; i ++){
					...
					if(targetExhibitionArray[i] != 0){
						...
						Play(mp3IndexBufferCharArray);
						char repeat4[6];
						strncpy(repeat4, mp3IndexBufferCharArray, 6);
				...
				for(int i = 0; i < 2; i ++){
					...
					if(targetExhibitionArray[i] != 0){
						...
						Play(mp3IndexBufferCharArray);
						char repeat5[6];
						strncpy(repeat5, mp3IndexBufferCharArray, 6);
