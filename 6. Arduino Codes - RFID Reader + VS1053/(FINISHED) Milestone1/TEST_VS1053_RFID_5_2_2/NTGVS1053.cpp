...
char mp3IndexName[mp3IndexMax][50] = {
...
void NTGVS1053::NTGVS1053Setup(){
	...
	vs1053.playFullFile("35.mp3"); //Welcome to museum X.
	vs1053.playFullFile("32.mp3"); //Please tap into exhibition
	vs1053.playFullFile("33.mp3"); //Prime.
...
void NTGVS1053::NTGVS1053Loop(){
	...
	while(!vs1053.playingMusic){
		PhysicalButton(vs1053.playingMusic);
		DebugSerialButton(vs1053.playingMusic);
		ntgRFIDReader.NTGRFIDReaderLoop(vs1053.playingMusic);
		ntgRFIDReader.GetExhibitionIndex();
	}
